...
sm.startChrome('https://lihkg.com/category/3','C:\\Program Files\\Google\\Chrome\\Application\\chromedriver.exe')
sm.minimize()


while True:
    print(f'{"_"*48}最新{"_"*48}')
    for i in range(1, 11):
        path_t = f'/html/body/div[1]/div[2]/div[1]/div/div[{i}]/div/div[2]/div[2]/span'
        path_c = f'/html/body/div[1]/div[2]/div[1]/div/div[{i}]/div/div[2]/a[2]'
